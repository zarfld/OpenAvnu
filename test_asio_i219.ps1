# ============================================================================
# ASIO Listener Test with Intel I219 Specific Configuration
# ============================================================================

Write-Host ""
Write-Host "🎵 ASIO Listener Test (Intel I219)" -ForegroundColor Magenta
Write-Host "===================================" -ForegroundColor Magenta
Write-Host ""

# Phase 1: Start Daemons
Write-Host "[PHASE 1] Starting OpenAvnu Daemons for Intel I219..." -ForegroundColor Cyan

# Check if start_openavnu_corrected.ps1 exists in different locations
$scriptLocations = @(
    ".\start_openavnu_corrected.ps1",
    "examples\asio-listener\start_openavnu_corrected.ps1"
)
...
if (-not $scriptFound) {
    Write-Host "⚠️  Daemon start script not found, checking if daemons are already running..." -ForegroundColor Yellow
}
