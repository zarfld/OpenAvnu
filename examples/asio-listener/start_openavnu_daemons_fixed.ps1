...
# Automatic Intel I219 Detection
# ============================================================================
...
function Start-OpenAvnuDaemons {
    ...
    # Step 1: Start gPTP Daemon (optional)
    if (-not $SkipGptp) {
        ...
        if (Test-Path $gptpPath) {
            ...
            Write-StatusMessage "gPTP daemon not found, skipping..." "WARNING"
        }
    } else {
        Write-StatusMessage "Skipping gPTP daemon startup as requested." "WARNING"
    }
    
    # Step 2: Start MRPD Daemon (required)
    ...
    # Step 3: Start MAAP Daemon (required)
    ...
    # Step 4: Start Windows Shaper (optional)
