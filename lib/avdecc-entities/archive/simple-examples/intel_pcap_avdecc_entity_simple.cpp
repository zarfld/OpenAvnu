...
public:
    ...
    bool send_adp_message() {
        ...
        // AVTP header (4 bytes) - Exactly match working M2Lab device
        raw_packet[14] = 0xFA;  // subtype=0x7A + stream_id_valid=0  
        raw_packet[15] = 0x00;  // version=0 + message_type=0
        raw_packet[16] = 0x00;  // EXACTLY as in working M2Lab device
        raw_packet[17] = 0x38;  // EXACTLY as in working M2Lab device (56 decimal)
