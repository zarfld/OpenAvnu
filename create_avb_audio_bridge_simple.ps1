...
Write-Host ""
Write-Host "AVB Audio Bridge" -ForegroundColor Magenta
...
Write-Host "  1. Open Windows Sound Settings" -ForegroundColor Gray
Write-Host "  2. Select CABLE Input as recording device" -ForegroundColor Gray
Write-Host "  3. Select CABLE Output as playback device" -ForegroundColor Gray
Write-Host "  4. AVB audio streams will appear in Windows" -ForegroundColor Gray
Write-Host ""
